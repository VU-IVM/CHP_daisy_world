...
Luminosiy_range = np.arange(0.5, 1.7, 0.002)
#Luminosiy_range = Luminosiy_range[::-1] <-- to reverse the array, needed for next practicum
...
# =============================================================================
plt.figure()
plt.plot(Luminosiy_range, eq_temperature, label='Temperature with daisies')
plt.plot(Luminosiy_range, temp_log_no_daisy, label='Temperature no daisies')
...
plt.figure()
plt.plot(Luminosiy_range, eq_area_WD, label='white daisies')
plt.plot(Luminosiy_range, eq_area_BD, label='black daisies')
plt.xlabel('Luminosity')
